...
use ESD\Nikic\PhpParser\Node\Expr\Cast\Double;
use ESD\Nikic\PhpParser\Node\Name;
use ESD\Nikic\PhpParser\Node\Param;
use ESD\Nikic\PhpParser\Node\Scalar\Encapsed;
use ESD\Nikic\PhpParser\Node\Scalar\LNumber;
use ESD\Nikic\PhpParser\Node\Scalar\String_;
...
use ESD\Nikic\PhpParser\Node\VarLikeIdentifier;
