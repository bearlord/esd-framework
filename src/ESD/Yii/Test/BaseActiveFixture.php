...
namespace ESD\Yii\Test;

use ESD\Yii\Base\ArrayAccessTrait;
...
abstract class BaseActiveFixture extends DbFixture implements \IteratorAggregate, \ArrayAccess, \Countable
{
    ...
    /**
     * @var \ESD\Yii\Db\ActiveRecord[] the loaded AR models
     */
    private $_models = [];
     ...
     * @return null|\ESD\Yii\Db\ActiveRecord the AR model, or null if the model cannot be found in the database
     * @throws \ESD\Yii\Base\InvalidConfigException if [[modelClass]] is not set.
     */
