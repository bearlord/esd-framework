...
use ESD\Yii\Web\Cookie;
use ESD\Yii\Web\CookieCollection;
use ESD\Yii\Web\HeaderCollection;
use ESD\Yii\Yii;
    ...
    public function addData($data)
    {
        if (empty($this->_data)) {
            ...
            if (!is_array($this->_data)) {
                throw new \ESD\Yii\Base\Exception('Unable to merge existing data with new data. Existing data is not an array.');
            }
