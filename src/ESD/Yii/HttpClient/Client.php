...
class Client extends Component
{
     ...
     */
    private $_transport = 'ESD\Yii\HttpClient\StreamTransport';
    ...
    public function getFormatter($format)
    {
        static $defaultFormatters = [
            self::FORMAT_JSON => 'ESD\Yii\HttpClient\JsonFormatter',
            self::FORMAT_URLENCODED => [
                'class' => 'ESD\Yii\HttpClient\UrlEncodedFormatter',
            ...
            self::FORMAT_XML => 'ESD\Yii\HttpClient\XmlFormatter',
            self::FORMAT_CURL => 'ESD\Yii\HttpClient\CurlFormatter',
        ];
    ...
    public function getParser($format)
    {
        static $defaultParsers = [
            self::FORMAT_JSON => 'ESD\Yii\HttpClient\JsonParser',
            self::FORMAT_URLENCODED => 'ESD\Yii\HttpClient\UrlEncodedParser',
            self::FORMAT_RAW_URLENCODED => 'ESD\Yii\HttpClient\UrlEncodedParser',
            self::FORMAT_XML => 'ESD\Yii\HttpClient\XmlParser',
        ];
