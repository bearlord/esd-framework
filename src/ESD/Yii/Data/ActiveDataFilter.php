...
namespace ESD\Yii\Data;

/**
 * ActiveDataFilter allows composing a filtering condition in a format suitable for [[\ESD\Yii\Db\QueryInterface::where()]].
 *
 * @see DataFilter
 *
...
class ActiveDataFilter extends DataFilter
{
    ...
    /**
     * @var array map filtering operators to operators used in [[\ESD\Yii\Db\QueryInterface::where()]].
     ...
     * used in [[\ESD\Yii\Db\QueryInterface::where()]]. However, you may want to adjust it in some special cases.
