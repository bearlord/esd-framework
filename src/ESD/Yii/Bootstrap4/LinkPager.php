...
/**
 * LinkPager represents a bootstrap 4 version of [[\ESD\Yii\Widgets\LinkPager]]. It displays a list of hyperlinks
 * that lead to different pages of target.
 *
 * LinkPager works with a [[use ESD\Yii\Widget\Pagination]] object which specifies the total number
 ...
 * 'container' => [
 *    'definitions' => [
 *       \ESD\Yii\Widgets\LinkPager::class => \ESD\Yii\Bootstrap4\LinkPager::class,
 *    ],
 * ],
 * ```
 *
