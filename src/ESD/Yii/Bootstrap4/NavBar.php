 ...
 * or [[\ESD\Yii\Widgets\Menu]] to build up such content. For example,
 *
 * ```php
...
class NavBar extends Widget
{
    ...
    /**
     * @var array|string|bool $url the URL for the brand's hyperlink tag. This parameter will be processed by [[\ESD\Yii\Helpers\Url::to()]]
     * and will be used for the "href" attribute of the brand link. Default value is false that means
     * [[\ESD\Yii\Web\Application::homeUrl]] will be used.
