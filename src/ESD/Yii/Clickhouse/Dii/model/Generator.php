...
use ESD\Yii\Clickhouse\ActiveRecord;
use ESD\Yii\Clickhouse\Connection;
use ESD\Yii\Gii\CodeFile;
...
class Generator extends \ESD\Yii\Gii\Generator
{
    ...
    public $baseClass = 'ESD\Yii\Clickhouse\ActiveRecord';
     ...
     * @param \ESD\Yii\Clickhouse\TableSchema $table the table schema
