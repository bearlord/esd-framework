...
class Connection extends Component
{
     ...
     */
    public $commandClass = 'ESD\Yii\Db\Command';
    /**
     ...
     */
    public $commandMap = [
        'pgsql' => 'ESD\Yii\Db\Command', // PostgreSQL
        'mysqli' => 'ESD\Yii\Db\Command', // MySQL
        'mysql' => 'ESD\Yii\Db\Command', // MySQL
        'sqlite' => 'ESD\Yii\Db\sqlite\Command', // sqlite 3
        'sqlite2' => 'ESD\Yii\Db\sqlite\Command', // sqlite 2
        'sqlsrv' => 'ESD\Yii\Db\Command', // newer MSSQL driver on MS Windows hosts
        'oci' => 'ESD\Yii\DbCommand', // Oracle driver
    ...
    public function createCommand($sql = null, $params = [])
    {
        ...
        $config = ['class' => 'ESD\Yii\Db\Command'];
