...
class Command extends Component
{
    ...
    protected function queryInternal($method, $fetchMode = null)
    {
        ...
        if ($method !== '') {
            ...
            if (is_array($info)) {
                ...
                if (is_array($result) && isset($result[0])) {
                    Yii::debug('Query result served from cache', 'ESD\Yii\Db\Command::query');
                    return $result[0];
                }
            }
        }
        ...
        try {
            $profile and Yii::beginProfile($rawSql, 'ESD\Yii\Db\Command::query');
        ...
        if (isset($cache, $cacheKey, $info)) {
            ...
            Yii::debug('Saved query result in cache', 'ESD\Yii\Db\Command::query');
        }
