...
class ColumnSchemaBuilder extends BaseObject
{
    ...
    /**
     * @var \ESD\Yii\Db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \ESD\Yii\Db\Connection $db the current database connection. See [[$db]].
