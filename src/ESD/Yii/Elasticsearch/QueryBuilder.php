...
class QueryBuilder extends BaseObject
{
     ...
     * @throws \ESD\Yii\Base\InvalidArgumentException if unknown operator is used in query
     * @throws \ESD\Yii\Base\NotSupportedException if string conditions are used in where
