...
class BaseArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = \ESD\Yii\Helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \ESD\Yii\Helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \ESD\Yii\Helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \ESD\Yii\Helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \ESD\Yii\Helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \ESD\Yii\Helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * $removed = \ESD\Yii\Helpers\ArrayHelper::removeValue($array, 'Jackson');
     * // result:
     ...
     * ];
     *
     * $result = \ESD\Yii\Helpers\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = \ESD\Yii\Helpers\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = \ESD\Yii\Helpers\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
