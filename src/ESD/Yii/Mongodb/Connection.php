...
class Connection extends Component
{
     ...
     * @since 2.1
     */
    public $fileStreamWrapperClass = 'ESD\Yii\Mongodb\File\StreamWrapper';
     ...
     * @since 2.1
     */
    private $_queryBuilder = 'ESD\Yii\Mongodb\QueryBuilder';
    /**
     * @var LogBuilder|array|string log entries builder used for this connecton.
     * @since 2.1
     */
    private $_logBuilder = 'ESD\Yii\Mongodb\LogBuilder';
    /**
    ...
    protected function selectDatabase($name)
    {
        return Yii::createObject([
            'class' => 'ESD\Yii\Mongodb\Database',
            'name' => $name,
            'connection' => $this,
        ]);
    }
