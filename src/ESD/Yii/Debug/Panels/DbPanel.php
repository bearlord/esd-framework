...
namespace ESD\Yii\Debug\Panels;

use ESD\Yii\Yii;
use ESD\Yii\Base\InvalidConfigException;
use ESD\Yii\Debug\Models\Search\Db;
use ESD\Yii\Debug\Panel;
...
class DbPanel extends Panel
{
    ...
    public function init()
    {
        $this->actions['db-explain'] = [
            'class' => 'ESD\Yii\\Debug\\Actions\\Db\\ExplainAction',
            'panel' => $this,
        ];
    }
     ...
     * 'ESD\Yii\Db\Command::query', 'ESD\Yii\Db\Command::execute'.
     * @return array
     */
    public function getProfileLogs()
    {
        return $this->getLogMessages(Logger::LEVEL_PROFILE, ['ESD\Yii\Db\Command::query', 'ESD\Yii\Db\Command::execute']);
    }
     ...
     * Can be used with data providers such as \ESD\Yii\Data\ArrayDataProvider.
     * @return array models
     */
