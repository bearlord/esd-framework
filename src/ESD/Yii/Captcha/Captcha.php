...
use ESD\Yii\Widgets\InputWidget;
 ...
 *
 * You may use [[\ESD\Yii\Captcha\CaptchaValidator]] to validate the user input matches
 ...
 * ```
 *
 * You can also use this widget in an [[\ESD\Yii\Widgets\ActiveForm|ActiveForm]] using the [[\ESD\Yii\Widgets\ActiveField::widget()|widget()]]
 * method, for example like this:
 *
 * ```php
 * <?= $form->field($model, 'captcha')->widget(\ESD\Yii\Captcha\Captcha::classname(), [
...
class Captcha extends InputWidget
{
     ...
     * Please refer to [[\ESD\Yii\Helpers\Url::toRoute()]] for acceptable formats.
     */
